...
def download(url):
    ...
    process = subprocess.Popen(
        ["spotdl", url, "--format", "mp3", "--overwrite", "force", "--cookie-file", "assetes/cookies-spotify.txt", "--yt-dlp-args", "--cookies assetes/cookies-youtube.txt", "--print-errors", "--log-level", "DEBUG"],
